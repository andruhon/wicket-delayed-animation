...
;(function (jQuery, undefined) {
	...
	/**
	 * An storage for temporary manual notify parameters and callbacks
	 */
	Wicket.Ajax.ManualNotify = {};
		...
		processEvaluation: function (context, node, nonce) {
			...
			var evaluateWithManualNotify = function (parameters, body) {
				return function(notify) {
					var manNotifyIndex = Date.now()+"_"+Math.random();
					Wicket.Ajax.ManualNotify[manNotifyIndex] = {};
					Wicket.Ajax.ManualNotify[manNotifyIndex]['parameters'] = parameters;
					Wicket.Ajax.ManualNotify[manNotifyIndex]['notify'] = notify;
					var toExecute = "var parameters = Wicket.Ajax.ManualNotify['"+manNotifyIndex+"']['parameters'];" +
						"var notify = Wicket.Ajax.ManualNotify['"+manNotifyIndex+"']['notify'];" +
						"(function() {" + body + "})();" +
						"Wicket.Ajax.ManualNotify['"+manNotifyIndex+"'] = undefined; delete Wicket.Ajax.ManualNotify['"+manNotifyIndex+"'];";
					try {
